 ...
 * @generated
 */
public class QueryShortcutPropertyTester extends PropertyTester {
	...
	*/
	public boolean test(Object receiver, String method, Object[] args, Object expectedValue) {
		...
		if (SHORTCUT_PROPERTY.equals(method)) {
			...
			if (annotation != null) {
				return QuerySurfaceEditPart.MODEL_ID.equals(annotation.getDetails().get("modelID")); //$NON-NLS-1$
			}
		}
		return false;
	}
