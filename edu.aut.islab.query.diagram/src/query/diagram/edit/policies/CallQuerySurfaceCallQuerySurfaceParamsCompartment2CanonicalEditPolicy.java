 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getFunction_Params();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7004SemanticChildren((View) getHost().getModel());
