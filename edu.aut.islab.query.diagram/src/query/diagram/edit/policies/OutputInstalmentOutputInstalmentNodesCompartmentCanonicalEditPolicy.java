 ...
 * @generated
 */
public class OutputInstalmentOutputInstalmentNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getOutputInstalment_Nodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getOutputInstalmentOutputInstalmentNodesCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getOutputInstalmentOutputInstalmentNodesCompartment_7008SemanticChildren((View) getHost().getModel());
