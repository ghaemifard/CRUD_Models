 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7009SemanticChildren((View) getHost().getModel());
