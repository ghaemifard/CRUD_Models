...
public class SortInstalmentSortInstalmentPointersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getSortInstalment_Pointers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7014SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FieldSPointerEditPart.VISUAL_ID == QueryVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7014SemanticChildren((View) getHost().getModel());
