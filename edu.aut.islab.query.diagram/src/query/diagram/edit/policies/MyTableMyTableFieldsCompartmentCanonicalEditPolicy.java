...
public class MyTableMyTableFieldsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getMyTable_Fields();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7011SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Field4EditPart.VISUAL_ID == QueryVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7011SemanticChildren((View) getHost().getModel());
