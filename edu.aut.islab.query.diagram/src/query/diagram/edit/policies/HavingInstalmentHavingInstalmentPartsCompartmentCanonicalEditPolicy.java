 ...
 * @generated
 */
public class HavingInstalmentHavingInstalmentPartsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getConditionInstalment_Parts();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getHavingInstalmentHavingInstalmentPartsCompartment_7007SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == RootJunctionEditPart.VISUAL_ID || visualID == JunctionEditPart.VISUAL_ID
				|| visualID == TermEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getHavingInstalmentHavingInstalmentPartsCompartment_7007SemanticChildren((View) getHost().getModel());
