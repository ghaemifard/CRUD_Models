 ...
 * @generated
 */
public class CallQuerySurface2ItemSemanticEditPolicy extends QueryBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CallQuerySurface2ItemSemanticEditPolicy() {
		super(QueryElementTypes.CallQuerySurface_3005);
	}
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (QueryVisualIDRegistry.getVisualID(node)) {
			case CallQuerySurfaceCallQuerySurfaceParamsCompartment2EditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (QueryVisualIDRegistry.getVisualID(cnode)) {
					...
					case FieldEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (QueryVisualIDRegistry
									.getVisualID(incomingLink) == LeftOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (QueryVisualIDRegistry
									.getVisualID(incomingLink) == RightOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (QueryVisualIDRegistry
									.getVisualID(incomingLink) == FullOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (QueryVisualIDRegistry
									.getVisualID(outgoingLink) == LeftOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (QueryVisualIDRegistry
									.getVisualID(outgoingLink) == RightOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (QueryVisualIDRegistry
									.getVisualID(outgoingLink) == FullOuterJoinRelsEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
