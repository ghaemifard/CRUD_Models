 ...
 * @generated
 */
public class GroupInstalmentGroupInstalmentPointersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getGroupInstalment_Pointers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getGroupInstalmentGroupInstalmentPointersCompartment_7013SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FieldGPointerEditPart.VISUAL_ID == QueryVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getGroupInstalmentGroupInstalmentPointersCompartment_7013SemanticChildren((View) getHost().getModel());
