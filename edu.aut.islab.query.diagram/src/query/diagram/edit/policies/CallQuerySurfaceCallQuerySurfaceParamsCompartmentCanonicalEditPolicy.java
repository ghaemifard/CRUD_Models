 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getCallQuerySurfaceCallQuerySurfaceParamsCompartment_7003SemanticChildren((View) getHost().getModel());
