...
import query.diagram.edit.commands.FullOuterJoinRelsCreateCommand;
import query.diagram.edit.commands.FullOuterJoinRelsReorientCommand;
...
import query.diagram.edit.commands.InnerjoinRelsCreateCommand;
import query.diagram.edit.commands.InnerjoinRelsReorientCommand;
import query.diagram.edit.commands.LeftOuterJoinRelsCreateCommand;
import query.diagram.edit.commands.LeftOuterJoinRelsReorientCommand;
...
import query.diagram.edit.commands.RightOuterJoinRelsCreateCommand;
import query.diagram.edit.commands.RightOuterJoinRelsReorientCommand;
 ...
 * @generated
 */
public class Field4ItemSemanticEditPolicy extends QueryBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Field4ItemSemanticEditPolicy() {
		super(QueryElementTypes.Field_3023);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (QueryVisualIDRegistry.getVisualID(incomingLink) == InnerjoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(incomingLink) == LeftOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(incomingLink) == RightOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(incomingLink) == FullOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (QueryVisualIDRegistry.getVisualID(outgoingLink) == InnerjoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(outgoingLink) == LeftOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(outgoingLink) == RightOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			}
			if (QueryVisualIDRegistry.getVisualID(outgoingLink) == FullOuterJoinRelsEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
