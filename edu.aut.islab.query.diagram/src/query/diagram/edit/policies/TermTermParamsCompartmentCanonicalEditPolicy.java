...
public class TermTermParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getTerm_Params();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getTermTermParamsCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getTermTermParamsCompartment_7002SemanticChildren((View) getHost().getModel());
