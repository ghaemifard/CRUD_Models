...
public class InputInstalmentInputInstalmentInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return QueryPackage.eINSTANCE.getInputInstalment_Inputs();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getInputInstalmentInputInstalmentInputsCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<QueryNodeDescriptor> childDescriptors = QueryDiagramUpdater
				.getInputInstalmentInputInstalmentInputsCompartment_7012SemanticChildren((View) getHost().getModel());
