 ...
 * @generated
 */
public class FieldGPointerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldGPointerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.FieldGPointer_3030, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldGPointerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
