 ...
 * @generated
 */
public class FieldName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Field_3023, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldName4EditPart.VISUAL_ID));
		}
		return parser;
	}
