...
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartmentCanonicalEditPolicy;
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceCallQuerySurfaceParamsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CallQuerySurfaceCallQuerySurfaceParamsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(QueryVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartmentCanonicalEditPolicy());
	}
