 ...
 * @generated
 */
public class CallQuerySurfaceNameColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceNameColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3004, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceNameColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
