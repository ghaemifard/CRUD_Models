 ...
 * @generated
 */
public class CallQuerySurfaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3004, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.CallQuerySurfaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
