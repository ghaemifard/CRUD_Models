 ...
 * @generated
 */
public class FunctionNameColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionNameColumn_name2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Function_3014, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FunctionNameColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
