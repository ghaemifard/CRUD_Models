...
public class MyTableNameAliasEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.MyTable_3022, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.MyTableNameAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
