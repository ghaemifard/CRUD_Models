...
public class FieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Field_3006, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
