...
public class InputIntDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.InputIntDef_3025, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InputIntDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
