...
public class InputInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.InputInstalment_2004, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InputInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
