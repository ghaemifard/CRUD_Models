...
import query.diagram.edit.policies.OutputInstalmentOutputInstalmentNodesCompartmentCanonicalEditPolicy;
import query.diagram.edit.policies.OutputInstalmentOutputInstalmentNodesCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputInstalmentOutputInstalmentNodesCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public OutputInstalmentOutputInstalmentNodesCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OutputInstalmentOutputInstalmentNodesCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutputInstalmentOutputInstalmentNodesCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(QueryVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OutputInstalmentOutputInstalmentNodesCompartmentCanonicalEditPolicy());
	}
