...
import query.diagram.edit.policies.QueryTextSelectionEditPolicy;
 ...
 * @generated
 */
public class LikeLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(QueryVisualIDRegistry.getType(query.diagram.edit.parts.LikeLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public LikeLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new QueryTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.LikeLink_4011, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.LikeLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, QueryEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LikeLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LikeLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LikeLinkLabelFigure() {
			this.setText("LikeLink");
		}
