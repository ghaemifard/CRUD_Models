 ...
 * @generated
 */
public class LiteralValueColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValueColumn_name3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Literal_3018, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.LiteralValueColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
