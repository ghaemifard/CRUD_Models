...
public class FieldName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Field_3011, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldName2EditPart.VISUAL_ID));
		}
		return parser;
	}
