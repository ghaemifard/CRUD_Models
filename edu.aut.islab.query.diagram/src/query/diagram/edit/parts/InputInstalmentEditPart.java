...
import query.diagram.edit.policies.InputInstalmentItemSemanticEditPolicy;
...
public class InputInstalmentEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(QueryVisualIDRegistry.getType(InputInstalmentNameEditPart.VISUAL_ID));
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == QueryElementTypes.InputStringDef_3024) {
			...
			if (type == QueryElementTypes.InputIntDef_3025) {
				return getChildBySemanticHint(QueryVisualIDRegistry
						.getType(InputInstalmentInputInstalmentInputsCompartmentEditPart.VISUAL_ID));
			}
			if (type == QueryElementTypes.InputDateDef_3026) {
				return getChildBySemanticHint(QueryVisualIDRegistry
						.getType(InputInstalmentInputInstalmentInputsCompartmentEditPart.VISUAL_ID));
			}
			if (type == QueryElementTypes.InputBitsDef_3027) {
				return getChildBySemanticHint(QueryVisualIDRegistry
						.getType(InputInstalmentInputInstalmentInputsCompartmentEditPart.VISUAL_ID));
			}
			if (type == QueryElementTypes.InputFloatDef_3032) {
				return getChildBySemanticHint(QueryVisualIDRegistry
						.getType(InputInstalmentInputInstalmentInputsCompartmentEditPart.VISUAL_ID));
			}
		}
