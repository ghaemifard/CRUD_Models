 ...
 * @generated
 */
public class FunctionNameColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionNameColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Function_3009, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FunctionNameColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
