...
public class InputColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Input_3010, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InputColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
