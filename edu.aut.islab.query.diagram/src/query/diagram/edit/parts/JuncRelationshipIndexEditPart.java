...
public class JuncRelationshipIndexEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				QueryVisualIDRegistry.getType(query.diagram.edit.parts.JuncRelationshipIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.JuncRelationship_4012, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.JuncRelationshipIndexEditPart.VISUAL_ID));
		}
		return parser;
	}
