 ...
 * @generated
 */
public class FunctionNameColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionNameColumn_name3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Function_3020, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FunctionNameColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
