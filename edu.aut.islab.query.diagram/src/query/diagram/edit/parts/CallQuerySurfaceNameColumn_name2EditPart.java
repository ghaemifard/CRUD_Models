 ...
 * @generated
 */
public class CallQuerySurfaceNameColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceNameColumn_name2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return QueryElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3005, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceNameColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
