 ...
 * @generated
 */
public class OutputInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OutputInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.OutputInstalment_2003, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.OutputInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
