 ...
 * @generated
 */
public class GroupInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.GroupInstalment_2005, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.GroupInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
