 ...
 * @generated
 */
public class NullLiteralColumn_nameValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_nameValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.NullLiteral_3008, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.NullLiteralColumn_nameValueEditPart.VISUAL_ID));
		}
		return parser;
	}
