...
public class FunctionColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Function_3014, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FunctionColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
