...
import query.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(QueryVisualIDRegistry.getType(InputColumn_nameEditPart.VISUAL_ID));
	}
