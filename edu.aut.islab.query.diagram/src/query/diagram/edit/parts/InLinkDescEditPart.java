...
public class InLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(QueryVisualIDRegistry.getType(query.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.InLink_4010, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
