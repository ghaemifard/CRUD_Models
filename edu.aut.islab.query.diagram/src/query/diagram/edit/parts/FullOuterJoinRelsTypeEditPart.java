...
public class FullOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				QueryVisualIDRegistry.getType(query.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.FullOuterJoinRels_4004, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
