 ...
 * @generated
 */
public class CallQuerySurfaceColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceColumn_nameName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3016, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
