...
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartment3CanonicalEditPolicy;
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartment3EditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceCallQuerySurfaceParamsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CallQuerySurfaceCallQuerySurfaceParamsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(QueryVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartment3CanonicalEditPolicy());
	}
