 ...
 * @generated
 */
public class CallQuerySurfaceColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceColumn_nameName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3005, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
