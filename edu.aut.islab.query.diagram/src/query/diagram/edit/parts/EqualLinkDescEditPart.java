...
public class EqualLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				QueryVisualIDRegistry.getType(query.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.EqualLink_4005, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
