 ...
 * @generated
 */
public class WhereInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public WhereInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.WhereInstalment_2001, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.WhereInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
