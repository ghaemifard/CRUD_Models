...
public class InputBitsDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.InputBitsDef_3027, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InputBitsDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
