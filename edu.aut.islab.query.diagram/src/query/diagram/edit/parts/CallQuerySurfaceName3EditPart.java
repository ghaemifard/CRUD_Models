 ...
 * @generated
 */
public class CallQuerySurfaceName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3016, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.CallQuerySurfaceName3EditPart.VISUAL_ID));
		}
		return parser;
	}
