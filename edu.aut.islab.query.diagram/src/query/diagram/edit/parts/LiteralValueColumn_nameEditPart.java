 ...
 * @generated
 */
public class LiteralValueColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValueColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Literal_3007, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.LiteralValueColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
