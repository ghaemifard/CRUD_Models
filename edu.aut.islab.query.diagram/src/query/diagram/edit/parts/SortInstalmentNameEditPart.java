...
public class SortInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.SortInstalment_2006, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.SortInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
