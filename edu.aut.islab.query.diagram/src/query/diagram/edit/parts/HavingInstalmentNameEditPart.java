 ...
 * @generated
 */
public class HavingInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HavingInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.HavingInstalment_2002, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.HavingInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
