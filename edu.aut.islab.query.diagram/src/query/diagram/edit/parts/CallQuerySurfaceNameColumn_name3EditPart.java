 ...
 * @generated
 */
public class CallQuerySurfaceNameColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceNameColumn_name3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3016, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceNameColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
