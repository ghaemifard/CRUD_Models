 ...
 * @generated
 */
public class LiteralValueColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValueColumn_name2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Literal_3012, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.LiteralValueColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
