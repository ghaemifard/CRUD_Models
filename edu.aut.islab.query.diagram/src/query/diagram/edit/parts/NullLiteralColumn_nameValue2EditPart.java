 ...
 * @generated
 */
public class NullLiteralColumn_nameValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_nameValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.NullLiteral_3013, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.NullLiteralColumn_nameValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
