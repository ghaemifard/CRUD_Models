 ...
 * @generated
 */
public class CallQuerySurfaceColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceColumn_nameNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.CallQuerySurface_3004, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.CallQuerySurfaceColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
