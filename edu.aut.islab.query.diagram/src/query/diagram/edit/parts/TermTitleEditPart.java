...
public class TermTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Term_3003, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.TermTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
