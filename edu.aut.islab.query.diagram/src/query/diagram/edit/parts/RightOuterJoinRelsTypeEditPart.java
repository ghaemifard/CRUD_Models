...
public class RightOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				QueryVisualIDRegistry.getType(query.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.RightOuterJoinRels_4003, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, QueryEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
