...
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartment2CanonicalEditPolicy;
import query.diagram.edit.policies.CallQuerySurfaceCallQuerySurfaceParamsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallQuerySurfaceCallQuerySurfaceParamsCompartment2EditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public CallQuerySurfaceCallQuerySurfaceParamsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.CallQuerySurfaceCallQuerySurfaceParamsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(QueryVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CallQuerySurfaceCallQuerySurfaceParamsCompartment2CanonicalEditPolicy());
	}
