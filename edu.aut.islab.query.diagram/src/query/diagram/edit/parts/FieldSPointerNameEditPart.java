...
public class FieldSPointerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.FieldSPointer_3031, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldSPointerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
