...
public class JunctionTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Junction_3002, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.JunctionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
