...
public class LiteralColumn_nameValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Literal_3018, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.LiteralColumn_nameValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
