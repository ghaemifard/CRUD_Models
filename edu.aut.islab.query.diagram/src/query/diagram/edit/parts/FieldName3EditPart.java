...
public class FieldName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.Field_3017, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.FieldName3EditPart.VISUAL_ID));
		}
		return parser;
	}
