 ...
 * @generated
 */
public class NullLiteralColumn_nameValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_nameValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.NullLiteral_3019, getParserElement(),
					QueryVisualIDRegistry
							.getType(query.diagram.edit.parts.NullLiteralColumn_nameValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
