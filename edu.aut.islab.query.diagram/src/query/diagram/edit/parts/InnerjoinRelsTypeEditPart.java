...
public class InnerjoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				QueryVisualIDRegistry.getType(query.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = QueryParserProvider.getParser(QueryElementTypes.InnerjoinRels_4001, getParserElement(),
					QueryVisualIDRegistry.getType(query.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
