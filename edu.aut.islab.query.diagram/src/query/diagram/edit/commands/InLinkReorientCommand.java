...
public class InLinkReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4010(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4010(container, getLink(), source,
				getNewTarget());
	}
