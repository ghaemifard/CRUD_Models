 ...
 * @generated
 */
public class LeftOuterJoinRelsReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public LeftOuterJoinRelsReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LeftOuterJoinRels) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistLeftOuterJoinRels_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected LeftOuterJoinRels getLink() {
		return (LeftOuterJoinRels) getElementToEdit();
	}
