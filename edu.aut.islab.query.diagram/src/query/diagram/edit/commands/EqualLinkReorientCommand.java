 ...
 * @generated
 */
public class EqualLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EqualLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof EqualLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistEqualLink_4005(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistEqualLink_4005(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected EqualLink getLink() {
		return (EqualLink) getElementToEdit();
	}
