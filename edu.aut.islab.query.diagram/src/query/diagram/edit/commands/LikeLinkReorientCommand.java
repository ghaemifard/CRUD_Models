...
public class LikeLinkReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistLikeLink_4011(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return QueryBaseItemSemanticEditPolicy.getLinkConstraints().canExistLikeLink_4011(container, getLink(), source,
				getNewTarget());
	}
