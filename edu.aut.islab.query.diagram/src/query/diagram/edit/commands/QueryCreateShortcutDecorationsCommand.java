 ...
 * @generated
 */
public class QueryCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public QueryCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put("modelID", QuerySurfaceEditPart.MODEL_ID); //$NON-NLS-1$
