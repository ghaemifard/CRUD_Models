...
/**
 * This is the item provider adapter for a {@link insert.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends NodeItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInpDefPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Inp Def feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInpDefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_inpDef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_inpDef_feature", "_UI_Input_type"),
				 InsertPackage.Literals.INPUT__INP_DEF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InsertPackage.Literals.INPUT__NAME,
				 true,
				 false,
				 false,
