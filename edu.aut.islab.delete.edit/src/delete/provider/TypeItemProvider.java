...
/**
 * This is the item provider adapter for a {@link delete.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeletePackage.Literals.TYPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSubtypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_subtypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_subtypes_feature", "_UI_Type_type"),
				 DeletePackage.Literals.TYPE__SUBTYPES,
				 true,
				 false,
				 true,
				 null,
