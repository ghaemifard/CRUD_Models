...
/**
 * This is the item provider adapter for a {@link delete.Dummy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DummyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dummy_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dummy_name_feature", "_UI_Dummy_type"),
				 DeletePackage.Literals.DUMMY__NAME,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeletePackage.Literals.DUMMY__PARTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dummy.class)) {
			case DeletePackage.DUMMY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DeletePackage.DUMMY__PARTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeletePackage.Literals.DUMMY__PARTS,
