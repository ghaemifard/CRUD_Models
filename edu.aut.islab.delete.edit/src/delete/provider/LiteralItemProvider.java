...
/**
 * This is the item provider adapter for a {@link delete.Literal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DeletePackage.Literals.LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addLtypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Literal_ltype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Literal_ltype_feature", "_UI_Literal_type"),
				 DeletePackage.Literals.LITERAL__LTYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Literal)object).getColumn_name();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Literal.class)) {
			case DeletePackage.LITERAL__VALUE:
			case DeletePackage.LITERAL__LTYPE:
