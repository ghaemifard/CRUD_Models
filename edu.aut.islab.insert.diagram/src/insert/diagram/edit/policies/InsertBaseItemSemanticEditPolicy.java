 ...
 * @generated
 */
public class InsertBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected InsertBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(InsertVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = InsertElementTypes.getElementType(getVisualID(request));
