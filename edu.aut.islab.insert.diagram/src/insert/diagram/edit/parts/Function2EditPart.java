...
import insert.diagram.edit.policies.Function2ItemSemanticEditPolicy;
...
public class Function2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FunctionName2EditPart) {
			((FunctionName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFunctionLabelFigure());
			return true;
		}
		if (childEditPart instanceof FunctionFunctionParamsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFunctionParamsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((FunctionFunctionParamsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FunctionFunctionParamsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFunctionParamsCompartmentFigure();
			pane.remove(((FunctionFunctionParamsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof FunctionFunctionParamsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(FunctionName2EditPart.VISUAL_ID));
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == InsertElementTypes.CallSurfaceQuery_3007) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
			if (type == InsertElementTypes.Field_3008) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
			if (type == InsertElementTypes.Literal_3009) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
			if (type == InsertElementTypes.NullLiteral_3010) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
			if (type == InsertElementTypes.Function_3011) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
			if (type == InsertElementTypes.Input_3012) {
				return getChildBySemanticHint(
						InsertVisualIDRegistry.getType(FunctionFunctionParamsCompartment2EditPart.VISUAL_ID));
			}
		}
