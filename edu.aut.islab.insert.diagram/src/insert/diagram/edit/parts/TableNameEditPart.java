...
public class TableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Table_2004, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.TableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
