 ...
 * @generated
 */
public class LiteralColumn_nameValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralColumn_nameValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Literal_3014, getParserElement(),
					InsertVisualIDRegistry
							.getType(insert.diagram.edit.parts.LiteralColumn_nameValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
