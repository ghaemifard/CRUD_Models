...
public class FunctionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Function_3016, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.FunctionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
