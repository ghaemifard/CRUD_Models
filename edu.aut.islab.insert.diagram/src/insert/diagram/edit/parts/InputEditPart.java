...
import insert.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(InputNameEditPart.VISUAL_ID));
	}
