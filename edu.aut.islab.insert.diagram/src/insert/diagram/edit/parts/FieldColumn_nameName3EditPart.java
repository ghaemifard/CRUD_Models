 ...
 * @generated
 */
public class FieldColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_nameName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Field_3013, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.FieldColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
