...
import insert.diagram.edit.policies.CallSurfaceQueryItemSemanticEditPolicy;
...
public class CallSurfaceQueryEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(CallSurfaceQueryNameEditPart.VISUAL_ID));
	}
