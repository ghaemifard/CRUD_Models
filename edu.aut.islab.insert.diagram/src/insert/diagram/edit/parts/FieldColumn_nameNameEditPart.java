 ...
 * @generated
 */
public class FieldColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_nameNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Field_3018, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.FieldColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
