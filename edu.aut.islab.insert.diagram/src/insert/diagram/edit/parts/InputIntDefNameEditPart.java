...
public class InputIntDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.InputIntDef_3003, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.InputIntDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
