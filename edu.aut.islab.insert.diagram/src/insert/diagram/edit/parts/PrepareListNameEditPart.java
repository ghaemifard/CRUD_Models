...
public class PrepareListNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.PrepareList_2003, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.PrepareListNameEditPart.VISUAL_ID));
		}
		return parser;
	}
