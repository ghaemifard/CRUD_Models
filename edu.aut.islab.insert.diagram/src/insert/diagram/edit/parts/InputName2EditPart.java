...
public class InputName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Input_3017, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.InputName2EditPart.VISUAL_ID));
		}
		return parser;
	}
