...
import insert.diagram.edit.policies.InsertTextSelectionEditPolicy;
 ...
 * @generated
 */
public class NullLiteralColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_name2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new InsertTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return InsertElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.NullLiteral_3015, getParserElement(),
					InsertVisualIDRegistry
							.getType(insert.diagram.edit.parts.NullLiteralColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, InsertEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
