 ...
 * @generated
 */
public class LiteralColumn_nameValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralColumn_nameValueEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Literal_3009, getParserElement(),
					InsertVisualIDRegistry
							.getType(insert.diagram.edit.parts.LiteralColumn_nameValueEditPart.VISUAL_ID));
		}
		return parser;
	}
