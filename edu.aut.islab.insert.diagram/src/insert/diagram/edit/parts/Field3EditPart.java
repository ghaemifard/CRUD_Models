...
import insert.diagram.edit.policies.Field3ItemSemanticEditPolicy;
...
public class Field3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldColumn_nameName3EditPart) {
			((FieldColumn_nameName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(FieldColumn_nameName3EditPart.VISUAL_ID));
	}
