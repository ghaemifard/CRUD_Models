...
import insert.diagram.edit.policies.PrepareListItemSemanticEditPolicy;
...
public class PrepareListEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(PrepareListNameEditPart.VISUAL_ID));
	}
