 ...
 * @generated
 */
public class InputStringDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputStringDefNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.InputStringDef_3002, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.InputStringDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
