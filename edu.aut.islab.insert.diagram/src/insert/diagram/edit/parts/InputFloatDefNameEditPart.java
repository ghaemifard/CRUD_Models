 ...
 * @generated
 */
public class InputFloatDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputFloatDefNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.InputFloatDef_3019, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.InputFloatDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
