 ...
 * @generated
 */
public class CallSurfaceQueryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.CallSurfaceQuery_3006, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.CallSurfaceQueryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
