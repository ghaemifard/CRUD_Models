 ...
 * @generated
 */
public class NullLiteralColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.NullLiteral_3010, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.NullLiteralColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
