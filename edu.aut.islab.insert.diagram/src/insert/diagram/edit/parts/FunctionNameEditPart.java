...
public class FunctionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Function_3011, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.FunctionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
