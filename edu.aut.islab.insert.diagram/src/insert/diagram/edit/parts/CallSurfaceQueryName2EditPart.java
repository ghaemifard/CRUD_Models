...
public class CallSurfaceQueryName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.CallSurfaceQuery_3007, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.CallSurfaceQueryName2EditPart.VISUAL_ID));
		}
		return parser;
	}
