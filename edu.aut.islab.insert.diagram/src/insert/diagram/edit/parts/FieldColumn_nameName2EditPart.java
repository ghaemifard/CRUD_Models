...
public class FieldColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.Field_3008, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.FieldColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
