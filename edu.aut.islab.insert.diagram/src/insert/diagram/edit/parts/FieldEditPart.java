...
import insert.diagram.edit.policies.FieldItemSemanticEditPolicy;
...
public class FieldEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldColumn_nameNameEditPart) {
			((FieldColumn_nameNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(FieldColumn_nameNameEditPart.VISUAL_ID));
	}
