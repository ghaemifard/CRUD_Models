...
import insert.diagram.edit.policies.CallSurfaceQuery2ItemSemanticEditPolicy;
...
public class CallSurfaceQuery2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallSurfaceQueryName2EditPart) {
			((CallSurfaceQueryName2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(InsertVisualIDRegistry.getType(CallSurfaceQueryName2EditPart.VISUAL_ID));
	}
