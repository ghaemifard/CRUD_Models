...
public class InputBitsDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = InsertParserProvider.getParser(InsertElementTypes.InputBitsDef_3005, getParserElement(),
					InsertVisualIDRegistry.getType(insert.diagram.edit.parts.InputBitsDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
