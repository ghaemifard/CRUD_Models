 ...
 * @generated
 */
public class UpdateShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = UpdateDiagramEditorPlugin.getInstance().getBundledImage("icons/shortcut.gif"); //$NON-NLS-1$
