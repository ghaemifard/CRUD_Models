 ...
 * @generated
 */
public class LowerThanLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public LowerThanLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LowerThanLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return UpdateBaseItemSemanticEditPolicy.getLinkConstraints().canExistLowerThanLink_4004(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected LowerThanLink getLink() {
		return (LowerThanLink) getElementToEdit();
	}
