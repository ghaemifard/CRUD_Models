 ...
 * @generated
 */
public class InLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof InLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return UpdateBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4006(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return UpdateBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4006(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected InLink getLink() {
		return (InLink) getElementToEdit();
	}
