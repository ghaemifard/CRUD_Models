 ...
 * @generated
 */
public class LowerEqualThanLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public LowerEqualThanLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LowerEqualThanLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return UpdateBaseItemSemanticEditPolicy.getLinkConstraints().canExistLowerEqualThanLink_4005(container,
	...
	* @generated
	*/
	protected LowerEqualThanLink getLink() {
		return (LowerEqualThanLink) getElementToEdit();
	}
