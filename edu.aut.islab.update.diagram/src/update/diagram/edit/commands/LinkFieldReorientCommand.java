 ...
 * @generated
 */
public class LinkFieldReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public LinkFieldReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LinkField) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof UpdateSurface)) {
			return false;
		}
		UpdateSurface container = (UpdateSurface) getLink().eContainer();
		return UpdateBaseItemSemanticEditPolicy.getLinkConstraints().canExistLinkField_4008(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		RealField source = getLink().getSrc();
		if (!(getLink().eContainer() instanceof UpdateSurface)) {
			return false;
		}
		UpdateSurface container = (UpdateSurface) getLink().eContainer();
	...
	* @generated
	*/
	protected LinkField getLink() {
		return (LinkField) getElementToEdit();
	}
