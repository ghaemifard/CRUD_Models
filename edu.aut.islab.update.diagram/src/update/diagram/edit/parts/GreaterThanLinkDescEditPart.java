 ...
 * @generated
 */
public class GreaterThanLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.GreaterThanLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public GreaterThanLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.GreaterThanLink_4002, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.GreaterThanLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new GreaterThanLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GreaterThanLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GreaterThanLinkLabelFigure() {
			this.setText("GreaterThanLink");
		}
