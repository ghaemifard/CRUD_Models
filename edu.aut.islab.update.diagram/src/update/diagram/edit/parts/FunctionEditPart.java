...
import update.diagram.edit.policies.FunctionItemSemanticEditPolicy;
...
public class FunctionEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(FunctionColumn_nameNameEditPart.VISUAL_ID));
	}
