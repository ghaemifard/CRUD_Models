...
import update.diagram.edit.policies.UpdateTextSelectionEditPolicy;
 ...
 * @generated
 */
public class GreaterEqualThanLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.GreaterEqualThanLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public GreaterEqualThanLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new UpdateTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.GreaterEqualThanLink_4003, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.GreaterEqualThanLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, UpdateEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new GreaterEqualThanLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GreaterEqualThanLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GreaterEqualThanLinkLabelFigure() {
			this.setText("GreaterEqualThanLink");
		}
