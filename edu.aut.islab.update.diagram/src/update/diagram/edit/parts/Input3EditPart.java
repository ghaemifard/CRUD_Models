...
import update.diagram.edit.policies.Input3ItemSemanticEditPolicy;
...
public class Input3EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(InputColumn_name3EditPart.VISUAL_ID));
	}
