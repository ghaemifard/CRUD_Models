...
import update.diagram.edit.policies.FunctionFunctionParamsCompartment3CanonicalEditPolicy;
import update.diagram.edit.policies.FunctionFunctionParamsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FunctionFunctionParamsCompartment3EditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public FunctionFunctionParamsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.FunctionFunctionParamsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FunctionFunctionParamsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UpdateVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new FunctionFunctionParamsCompartment3CanonicalEditPolicy());
	}
