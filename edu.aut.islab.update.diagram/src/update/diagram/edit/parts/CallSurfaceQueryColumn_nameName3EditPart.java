...
public class CallSurfaceQueryColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected Image getLabelIcon() {
		...
		return UpdateElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.CallSurfaceQuery_3020, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.CallSurfaceQueryColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
