 ...
 * @generated
 */
public class LinkFieldNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LinkFieldNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public LinkFieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.LinkField_4008, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LinkFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LinkFieldLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LinkFieldLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LinkFieldLabelFigure() {
			this.setText("LinkField");
		}
