 ...
 * @generated
 */
public class FieldColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Field_3007, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.FieldColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
