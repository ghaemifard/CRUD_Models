...
import update.diagram.edit.policies.FieldItemSemanticEditPolicy;
...
public class FieldEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldColumn_nameEditPart) {
			((FieldColumn_nameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(FieldColumn_nameEditPart.VISUAL_ID));
	}
