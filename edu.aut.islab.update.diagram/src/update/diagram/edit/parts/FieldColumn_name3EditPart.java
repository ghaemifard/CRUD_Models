...
public class FieldColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Field_3021, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.FieldColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
