 ...
 * @generated
 */
public class SortInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SortInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.SortInstalment_2005, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.SortInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
