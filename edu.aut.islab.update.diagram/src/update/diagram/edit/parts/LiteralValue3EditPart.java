 ...
 * @generated
 */
public class LiteralValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Literal_3022, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LiteralValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
