 ...
 * @generated
 */
public class FunctionColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionColumn_nameName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Function_3015, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.FunctionColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
