...
import update.diagram.edit.policies.CallSurfaceQueryItemSemanticEditPolicy;
...
public class CallSurfaceQueryEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallSurfaceQueryColumn_nameNameEditPart) {
			((CallSurfaceQueryColumn_nameNameEditPart) childEditPart)
