...
public class FunctionColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Function_3024, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.FunctionColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
