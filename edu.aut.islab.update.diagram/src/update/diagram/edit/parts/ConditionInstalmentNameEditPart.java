 ...
 * @generated
 */
public class ConditionInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ConditionInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.ConditionInstalment_2004, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.ConditionInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
