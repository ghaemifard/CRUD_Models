...
public class LiteralValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Literal_3008, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LiteralValueEditPart.VISUAL_ID));
		}
		return parser;
	}
