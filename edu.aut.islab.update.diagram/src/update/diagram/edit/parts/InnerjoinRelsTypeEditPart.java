 ...
 * @generated
 */
public class InnerjoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public InnerjoinRelsTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.InnerjoinRels_4010, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InnerjoinRelsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InnerjoinRelsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InnerjoinRelsLabelFigure() {
			this.setText("InnerjoinRels");
		}
