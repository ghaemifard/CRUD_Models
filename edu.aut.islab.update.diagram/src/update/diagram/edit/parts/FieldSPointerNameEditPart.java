 ...
 * @generated
 */
public class FieldSPointerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldSPointerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.FieldSPointer_3030, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.FieldSPointerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
