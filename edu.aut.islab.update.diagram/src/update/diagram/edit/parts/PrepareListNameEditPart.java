 ...
 * @generated
 */
public class PrepareListNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PrepareListNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.PrepareList_2002, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.PrepareListNameEditPart.VISUAL_ID));
		}
		return parser;
	}
