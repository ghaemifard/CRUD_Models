...
public class NullLiteralValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.NullLiteral_3009, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.NullLiteralValueEditPart.VISUAL_ID));
		}
		return parser;
	}
