...
public class RightOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.RightOuterJoinRels_4012, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, UpdateEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
