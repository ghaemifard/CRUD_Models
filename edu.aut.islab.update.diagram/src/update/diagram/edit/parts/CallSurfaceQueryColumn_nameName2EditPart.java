...
public class CallSurfaceQueryColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.CallSurfaceQuery_3006, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.CallSurfaceQueryColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
