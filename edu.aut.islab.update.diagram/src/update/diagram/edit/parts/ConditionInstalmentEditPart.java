...
import update.diagram.edit.policies.ConditionInstalmentItemSemanticEditPolicy;
...
public class ConditionInstalmentEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(ConditionInstalmentNameEditPart.VISUAL_ID));
	}
