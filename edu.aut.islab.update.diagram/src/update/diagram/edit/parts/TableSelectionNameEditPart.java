 ...
 * @generated
 */
public class TableSelectionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TableSelectionNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.TableSelection_2003, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.TableSelectionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
