 ...
 * @generated
 */
public class LiteralValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValue2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Literal_3013, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LiteralValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
