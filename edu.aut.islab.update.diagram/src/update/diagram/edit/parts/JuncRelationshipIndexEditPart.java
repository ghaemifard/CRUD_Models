...
public class JuncRelationshipIndexEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.JuncRelationshipIndexEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.JuncRelationship_4014, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.JuncRelationshipIndexEditPart.VISUAL_ID));
		}
		return parser;
	}
