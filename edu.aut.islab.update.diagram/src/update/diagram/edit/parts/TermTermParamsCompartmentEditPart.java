...
import update.diagram.edit.policies.TermTermParamsCompartmentCanonicalEditPolicy;
import update.diagram.edit.policies.TermTermParamsCompartmentItemSemanticEditPolicy;
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UpdateElementTypes.CallSurfaceQuery_3020) {
				return this;
			}
			if (type == UpdateElementTypes.Field_3021) {
				return this;
			}
			if (type == UpdateElementTypes.Literal_3022) {
				return this;
			}
			if (type == UpdateElementTypes.NullLiteral_3023) {
				return this;
			}
			if (type == UpdateElementTypes.Function_3024) {
				return this;
			}
			if (type == UpdateElementTypes.Input_3025) {
				return this;
			}
