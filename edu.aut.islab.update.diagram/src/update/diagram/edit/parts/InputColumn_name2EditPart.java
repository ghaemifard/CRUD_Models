...
public class InputColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Input_3016, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InputColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
