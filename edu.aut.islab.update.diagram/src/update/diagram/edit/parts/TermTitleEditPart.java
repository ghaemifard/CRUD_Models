 ...
 * @generated
 */
public class TermTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TermTitleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Term_3019, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.TermTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
