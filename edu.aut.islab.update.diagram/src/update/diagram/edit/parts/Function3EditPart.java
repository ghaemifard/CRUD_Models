...
import update.diagram.edit.policies.Function3ItemSemanticEditPolicy;
...
public class Function3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FunctionColumn_nameName3EditPart) {
			((FunctionColumn_nameName3EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(FunctionColumn_nameName3EditPart.VISUAL_ID));
	}
