...
public class NullLiteralValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.NullLiteral_3014, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.NullLiteralValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
