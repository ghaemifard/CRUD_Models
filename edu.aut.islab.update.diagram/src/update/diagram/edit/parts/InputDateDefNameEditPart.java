 ...
 * @generated
 */
public class InputDateDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputDateDefNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.InputDateDef_3003, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InputDateDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
