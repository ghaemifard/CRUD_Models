...
public class JunctionTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Junction_3032, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.JunctionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
