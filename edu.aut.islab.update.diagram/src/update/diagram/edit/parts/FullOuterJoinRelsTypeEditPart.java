...
public class FullOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.FullOuterJoinRels_4013, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
