...
import update.diagram.edit.policies.Field3ItemSemanticEditPolicy;
...
public class Field3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldColumn_name3EditPart) {
			((FieldColumn_name3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(FieldColumn_name3EditPart.VISUAL_ID));
	}
