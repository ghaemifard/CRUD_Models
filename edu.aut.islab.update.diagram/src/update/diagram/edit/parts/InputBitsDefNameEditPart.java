 ...
 * @generated
 */
public class InputBitsDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputBitsDefNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.InputBitsDef_3004, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InputBitsDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
