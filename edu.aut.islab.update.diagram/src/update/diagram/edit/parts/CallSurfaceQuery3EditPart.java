...
import update.diagram.edit.policies.CallSurfaceQuery3ItemSemanticEditPolicy;
...
public class CallSurfaceQuery3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallSurfaceQueryColumn_nameName3EditPart) {
			((CallSurfaceQueryColumn_nameName3EditPart) childEditPart)
