 ...
 * @generated
 */
public class FunctionColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionColumn_nameNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Function_3010, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.FunctionColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
