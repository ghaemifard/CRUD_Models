 ...
 * @generated
 */
public class InputIntDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputIntDefNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.InputIntDef_3002, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InputIntDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
