...
public class LeftOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LeftOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.LeftOuterJoinRels_4011, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LeftOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
