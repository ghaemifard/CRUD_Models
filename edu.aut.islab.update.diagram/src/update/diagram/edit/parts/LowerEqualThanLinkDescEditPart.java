 ...
 * @generated
 */
public class LowerEqualThanLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LowerEqualThanLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public LowerEqualThanLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.LowerEqualThanLink_4005, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.LowerEqualThanLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LowerEqualThanLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LowerEqualThanLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LowerEqualThanLinkLabelFigure() {
			this.setText("LowerEqualThanLink");
		}
