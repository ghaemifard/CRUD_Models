...
public class MyTableNameAliasEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.MyTable_3026, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.MyTableNameAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
