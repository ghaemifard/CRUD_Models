...
public class CallSurfaceQueryColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.CallSurfaceQuery_3005, getParserElement(),
					UpdateVisualIDRegistry
							.getType(update.diagram.edit.parts.CallSurfaceQueryColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
