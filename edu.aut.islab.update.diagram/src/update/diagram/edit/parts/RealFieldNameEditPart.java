 ...
 * @generated
 */
public class RealFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RealFieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.RealField_3029, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.RealFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
