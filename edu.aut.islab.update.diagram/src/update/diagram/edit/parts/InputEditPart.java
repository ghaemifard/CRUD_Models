...
import update.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputColumn_nameEditPart) {
			((InputColumn_nameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(InputColumn_nameEditPart.VISUAL_ID));
	}
