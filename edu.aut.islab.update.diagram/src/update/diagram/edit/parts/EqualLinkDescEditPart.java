 ...
 * @generated
 */
public class EqualLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				UpdateVisualIDRegistry.getType(update.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EqualLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.EqualLink_4001, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EqualLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EqualLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EqualLinkLabelFigure() {
			this.setText("EqualLink");
		}
