 ...
 * @generated
 */
public class NullLiteralValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.NullLiteral_3023, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.NullLiteralValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
