...
import update.diagram.edit.policies.Input2ItemSemanticEditPolicy;
...
public class Input2EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(InputColumn_name2EditPart.VISUAL_ID));
	}
