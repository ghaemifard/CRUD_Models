...
public class InputColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.Input_3011, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InputColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
