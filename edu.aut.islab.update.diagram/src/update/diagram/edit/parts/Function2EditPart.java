...
import update.diagram.edit.policies.Function2ItemSemanticEditPolicy;
...
public class Function2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FunctionColumn_nameName2EditPart) {
			((FunctionColumn_nameName2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UpdateVisualIDRegistry.getType(FunctionColumn_nameName2EditPart.VISUAL_ID));
	}
