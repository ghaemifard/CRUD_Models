 ...
 * @generated
 */
public class InLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public InLinkDescEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UpdateParserProvider.getParser(UpdateElementTypes.InLink_4006, getParserElement(),
					UpdateVisualIDRegistry.getType(update.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InLinkLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InLinkLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InLinkLabelFigure() {
			this.setText("InLink");
		}
