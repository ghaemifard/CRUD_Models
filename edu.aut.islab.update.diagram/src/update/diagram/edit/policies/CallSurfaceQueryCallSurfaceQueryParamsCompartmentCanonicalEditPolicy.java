...
public class CallSurfaceQueryCallSurfaceQueryParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7003SemanticChildren((View) getHost().getModel());
