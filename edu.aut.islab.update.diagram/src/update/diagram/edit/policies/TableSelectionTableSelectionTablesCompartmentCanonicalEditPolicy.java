 ...
 * @generated
 */
public class TableSelectionTableSelectionTablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getTableSelection_Tables();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getTableSelectionTableSelectionTablesCompartment_7011SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MyTableEditPart.VISUAL_ID == UpdateVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getTableSelectionTableSelectionTablesCompartment_7011SemanticChildren((View) getHost().getModel());
