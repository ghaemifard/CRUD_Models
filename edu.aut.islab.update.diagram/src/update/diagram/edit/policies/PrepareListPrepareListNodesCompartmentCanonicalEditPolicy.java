...
public class PrepareListPrepareListNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getPrepareList_Nodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getPrepareListPrepareListNodesCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getPrepareListPrepareListNodesCompartment_7002SemanticChildren((View) getHost().getModel());
