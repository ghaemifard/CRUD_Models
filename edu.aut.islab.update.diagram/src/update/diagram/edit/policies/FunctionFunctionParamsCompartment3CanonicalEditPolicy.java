 ...
 * @generated
 */
public class FunctionFunctionParamsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getFunctionFunctionParamsCompartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getFunctionFunctionParamsCompartment_7010SemanticChildren((View) getHost().getModel());
