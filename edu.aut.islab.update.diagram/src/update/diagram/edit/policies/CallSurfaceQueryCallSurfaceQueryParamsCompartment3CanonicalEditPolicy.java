...
public class CallSurfaceQueryCallSurfaceQueryParamsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getFunction_Params();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7009SemanticChildren((View) getHost().getModel());
