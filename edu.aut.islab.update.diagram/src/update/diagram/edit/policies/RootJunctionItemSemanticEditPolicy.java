 ...
 * @generated
 */
public class RootJunctionItemSemanticEditPolicy extends UpdateBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public RootJunctionItemSemanticEditPolicy() {
		super(UpdateElementTypes.RootJunction_3031);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (UpdateVisualIDRegistry.getVisualID(outgoingLink) == JuncRelationshipEditPart.VISUAL_ID) {
