...
public class SortInstalmentSortInstalmentPointersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getSortInstalment_Pointers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7013SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FieldSPointerEditPart.VISUAL_ID == UpdateVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7013SemanticChildren((View) getHost().getModel());
