 ...
 * @generated
 */
public class MyTableMyTableFakesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getMyTable_Fakes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getMyTableMyTableFakesCompartment_7012SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return RealFieldEditPart.VISUAL_ID == UpdateVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getMyTableMyTableFakesCompartment_7012SemanticChildren((View) getHost().getModel());
