...
public class ConditionInstalmentConditionInstalmentPartsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UpdatePackage.eINSTANCE.getConditionInstalment_Parts();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getConditionInstalmentConditionInstalmentPartsCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UpdateNodeDescriptor> childDescriptors = UpdateDiagramUpdater
				.getConditionInstalmentConditionInstalmentPartsCompartment_7007SemanticChildren(
