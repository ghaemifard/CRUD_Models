 ...
 * @generated
 */
public class UpdateShortcutPropertyTester extends PropertyTester {
	...
	*/
	public boolean test(Object receiver, String method, Object[] args, Object expectedValue) {
		...
		if (SHORTCUT_PROPERTY.equals(method)) {
			...
			if (annotation != null) {
				return UpdateSurfaceEditPart.MODEL_ID.equals(annotation.getDetails().get("modelID")); //$NON-NLS-1$
			}
		}
		return false;
	}
