...
public class CallSurfaceQueryCallSurfaceQueryParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7011SemanticChildren((View) getHost().getModel());
