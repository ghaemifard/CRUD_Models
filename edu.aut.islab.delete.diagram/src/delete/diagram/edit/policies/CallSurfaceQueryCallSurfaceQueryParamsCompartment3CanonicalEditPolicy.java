 ...
 * @generated
 */
public class CallSurfaceQueryCallSurfaceQueryParamsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getFunction_Params();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7022SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7022SemanticChildren((View) getHost().getModel());
