 ...
 * @generated
 */
public class DummyDummyPartsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getDummy_Parts();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getDummyDummyPartsCompartment_7021SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getDummyDummyPartsCompartment_7021SemanticChildren((View) getHost().getModel());
