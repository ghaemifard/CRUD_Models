 ...
 * @generated
 */
public class TableListInstalmentTableListInstalmentTablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getTableListInstalment_Tables();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getTableListInstalmentTableListInstalmentTablesCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MyTableEditPart.VISUAL_ID == DeleteVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getTableListInstalmentTableListInstalmentTablesCompartment_7002SemanticChildren(
