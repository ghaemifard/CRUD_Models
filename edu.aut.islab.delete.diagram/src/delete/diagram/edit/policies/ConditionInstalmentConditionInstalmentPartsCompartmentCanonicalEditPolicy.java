 ...
 * @generated
 */
public class ConditionInstalmentConditionInstalmentPartsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getConditionInstalment_Parts();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getConditionInstalmentConditionInstalmentPartsCompartment_7018SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getConditionInstalmentConditionInstalmentPartsCompartment_7018SemanticChildren(
