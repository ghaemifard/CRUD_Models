 ...
 * @generated
 */
public class MyTableMyTableFieldsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7025SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7025SemanticChildren((View) getHost().getModel());
