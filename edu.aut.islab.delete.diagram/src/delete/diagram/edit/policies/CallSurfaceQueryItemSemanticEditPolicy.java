 ...
 * @generated
 */
public class CallSurfaceQueryItemSemanticEditPolicy extends DeleteBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CallSurfaceQueryItemSemanticEditPolicy() {
		super(DeleteElementTypes.CallSurfaceQuery_3025);
	}
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (DeleteVisualIDRegistry.getVisualID(node)) {
			case CallSurfaceQueryCallSurfaceQueryParamsCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (DeleteVisualIDRegistry.getVisualID(cnode)) {
