 ...
 * @generated
 */
public class SortInstalmentSortInstalmentPointersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getSortInstalment_Pointers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7020SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FieldSPointerEditPart.VISUAL_ID == DeleteVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getSortInstalmentSortInstalmentPointersCompartment_7020SemanticChildren((View) getHost().getModel());
