 ...
 * @generated
 */
public class ConditionInstalmentItemSemanticEditPolicy extends DeleteBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ConditionInstalmentItemSemanticEditPolicy() {
					...
					case RootJunctionEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (DeleteVisualIDRegistry
									.getVisualID(incomingLink) == JuncRelationshipEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (DeleteVisualIDRegistry
									.getVisualID(outgoingLink) == JuncRelationshipEditPart.VISUAL_ID) {
