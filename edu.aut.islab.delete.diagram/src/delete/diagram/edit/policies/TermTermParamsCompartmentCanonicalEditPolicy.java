...
public class TermTermParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getTerm_Params();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getTermTermParamsCompartment_7019SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getTermTermParamsCompartment_7019SemanticChildren((View) getHost().getModel());
