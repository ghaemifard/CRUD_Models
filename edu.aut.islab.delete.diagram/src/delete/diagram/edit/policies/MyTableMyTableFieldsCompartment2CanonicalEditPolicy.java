 ...
 * @generated
 */
public class MyTableMyTableFieldsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DeletePackage.eINSTANCE.getMyTable_Fields();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7026SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FieldEditPart.VISUAL_ID == DeleteVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getMyTableMyTableFieldsCompartment_7026SemanticChildren((View) getHost().getModel());
