...
public class CallSurfaceQueryCallSurfaceQueryParamsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DeleteNodeDescriptor> childDescriptors = DeleteDiagramUpdater
				.getCallSurfaceQueryCallSurfaceQueryParamsCompartment_7008SemanticChildren((View) getHost().getModel());
