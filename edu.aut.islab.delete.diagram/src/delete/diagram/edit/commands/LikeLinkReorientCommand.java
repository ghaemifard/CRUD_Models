...
public class LikeLinkReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return DeleteBaseItemSemanticEditPolicy.getLinkConstraints().canExistLikeLink_4012(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return DeleteBaseItemSemanticEditPolicy.getLinkConstraints().canExistLikeLink_4012(container, getLink(), source,
				getNewTarget());
	}
