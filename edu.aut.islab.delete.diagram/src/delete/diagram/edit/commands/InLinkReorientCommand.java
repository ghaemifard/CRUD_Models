...
public class InLinkReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return DeleteBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4011(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Term container = (Term) getLink().eContainer();
		return DeleteBaseItemSemanticEditPolicy.getLinkConstraints().canExistInLink_4011(container, getLink(), source,
				getNewTarget());
	}
