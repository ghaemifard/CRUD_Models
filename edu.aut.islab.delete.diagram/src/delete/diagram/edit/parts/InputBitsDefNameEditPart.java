...
public class InputBitsDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputBitsDef_3004, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputBitsDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
