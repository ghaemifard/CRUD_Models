...
import delete.diagram.edit.policies.FunctionItemSemanticEditPolicy;
...
public class FunctionEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(FunctionNameEditPart.VISUAL_ID));
	}
