 ...
 * @generated
 */
public class LeftOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.LeftOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public LeftOuterJoinRelsTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.LeftOuterJoinRels_4002, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.LeftOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new LeftOuterJoinRelsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LeftOuterJoinRelsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LeftOuterJoinRelsLabelFigure() {
			this.setText("LeftOuterJoinRels");
		}
