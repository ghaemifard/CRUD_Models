 ...
 * @generated
 */
public class FunctionName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Function_3048, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FunctionName3EditPart.VISUAL_ID));
		}
		return parser;
	}
