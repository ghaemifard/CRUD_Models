 ...
 * @generated
 */
public class FunctionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Function_3028, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FunctionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
