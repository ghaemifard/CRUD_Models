 ...
 * @generated
 */
public class NullLiteralValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralValue2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.NullLiteral_3027, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.NullLiteralValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
