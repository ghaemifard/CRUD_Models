...
public class InputIntDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputIntDef_3002, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputIntDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
