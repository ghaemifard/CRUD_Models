 ...
 * @generated
 */
public class CallSurfaceQueryName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.CallSurfaceQuery_3044, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.CallSurfaceQueryName3EditPart.VISUAL_ID));
		}
		return parser;
	}
