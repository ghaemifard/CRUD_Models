 ...
 * @generated
 */
public class JunctionTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public JunctionTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Junction_3041, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.JunctionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
