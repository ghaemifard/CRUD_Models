 ...
 * @generated
 */
public class LiteralColumn_nameValue3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralColumn_nameValue3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Literal_3046, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.LiteralColumn_nameValue3EditPart.VISUAL_ID));
		}
		return parser;
	}
