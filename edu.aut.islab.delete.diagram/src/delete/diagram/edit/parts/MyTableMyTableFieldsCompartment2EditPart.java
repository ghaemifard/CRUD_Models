...
import delete.diagram.edit.policies.MyTableMyTableFieldsCompartment2CanonicalEditPolicy;
import delete.diagram.edit.policies.MyTableMyTableFieldsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MyTableMyTableFieldsCompartment2EditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public MyTableMyTableFieldsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.MyTableMyTableFieldsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MyTableMyTableFieldsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(DeleteVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MyTableMyTableFieldsCompartment2CanonicalEditPolicy());
	}
