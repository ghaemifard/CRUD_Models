...
public class ConditionInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.ConditionInstalment_2005, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.ConditionInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
