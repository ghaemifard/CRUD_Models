...
public class LiteralColumn_nameValue2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Literal_3026, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.LiteralColumn_nameValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
