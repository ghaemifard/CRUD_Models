...
public class TermTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Term_3042, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.TermTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
