 ...
 * @generated
 */
public class TableListInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TableListInstalmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.TableListInstalment_2002, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.TableListInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
