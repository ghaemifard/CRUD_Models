...
public class NullLiteralColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.NullLiteral_3027, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.NullLiteralColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
