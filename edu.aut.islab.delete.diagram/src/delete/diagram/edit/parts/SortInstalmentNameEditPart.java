...
public class SortInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.SortInstalment_2006, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.SortInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
