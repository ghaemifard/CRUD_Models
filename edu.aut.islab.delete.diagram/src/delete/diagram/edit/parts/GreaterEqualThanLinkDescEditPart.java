...
import delete.diagram.edit.policies.DeleteTextSelectionEditPolicy;
...
public class GreaterEqualThanLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.GreaterEqualThanLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new DeleteTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.GreaterEqualThanLink_4008, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.GreaterEqualThanLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, DeleteEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
