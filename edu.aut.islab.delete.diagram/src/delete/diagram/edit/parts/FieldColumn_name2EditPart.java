 ...
 * @generated
 */
public class FieldColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_name2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Field_3015, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FieldColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
