...
public class InputFloatDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputFloatDef_3037, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputFloatDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
