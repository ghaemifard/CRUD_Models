...
public class InnerjoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InnerjoinRels_4001, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InnerjoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
