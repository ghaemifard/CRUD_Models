...
public class FunctionColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Function_3018, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.FunctionColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
