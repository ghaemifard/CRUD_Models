 ...
 * @generated
 */
public class RightOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RightOuterJoinRelsTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.RightOuterJoinRels_4003, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.RightOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, DeleteEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RightOuterJoinRelsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RightOuterJoinRelsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RightOuterJoinRelsLabelFigure() {
			this.setText("RightOuterJoinRels");
		}
