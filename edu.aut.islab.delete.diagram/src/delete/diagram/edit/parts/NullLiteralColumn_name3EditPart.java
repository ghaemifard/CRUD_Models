 ...
 * @generated
 */
public class NullLiteralColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralColumn_name3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.NullLiteral_3047, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.NullLiteralColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
