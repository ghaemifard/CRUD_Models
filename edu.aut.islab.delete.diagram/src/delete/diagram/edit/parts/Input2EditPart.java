...
import delete.diagram.edit.policies.Input2ItemSemanticEditPolicy;
...
public class Input2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputColumn_name2EditPart) {
			((InputColumn_name2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(InputColumn_name2EditPart.VISUAL_ID));
	}
