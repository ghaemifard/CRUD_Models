 ...
 * @generated
 */
public class NullLiteralValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullLiteralValueEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.NullLiteral_3017, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.NullLiteralValueEditPart.VISUAL_ID));
		}
		return parser;
	}
