 ...
 * @generated
 */
public class CallSurfaceQueryColumn_nameNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryColumn_nameNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.CallSurfaceQuery_3025, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.CallSurfaceQueryColumn_nameNameEditPart.VISUAL_ID));
		}
		return parser;
	}
