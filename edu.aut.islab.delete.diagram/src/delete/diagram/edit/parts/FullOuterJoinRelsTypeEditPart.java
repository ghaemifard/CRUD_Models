 ...
 * @generated
 */
public class FullOuterJoinRelsTypeEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public FullOuterJoinRelsTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.FullOuterJoinRels_4004, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FullOuterJoinRelsTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new FullOuterJoinRelsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FullOuterJoinRelsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FullOuterJoinRelsLabelFigure() {
			this.setText("FullOuterJoinRels");
		}
