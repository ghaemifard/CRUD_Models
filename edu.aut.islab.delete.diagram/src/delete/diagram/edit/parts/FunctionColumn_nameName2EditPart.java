...
public class FunctionColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Function_3028, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.FunctionColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
