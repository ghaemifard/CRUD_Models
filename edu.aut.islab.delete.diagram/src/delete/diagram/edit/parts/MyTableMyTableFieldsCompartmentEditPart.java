...
import delete.diagram.edit.policies.MyTableMyTableFieldsCompartmentCanonicalEditPolicy;
import delete.diagram.edit.policies.MyTableMyTableFieldsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MyTableMyTableFieldsCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public MyTableMyTableFieldsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.MyTableMyTableFieldsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MyTableMyTableFieldsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(DeleteVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new MyTableMyTableFieldsCompartmentCanonicalEditPolicy());
	}
