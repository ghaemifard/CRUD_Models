...
import delete.diagram.edit.policies.CallSurfaceQuery3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallSurfaceQuery3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CallSurfaceQuery3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallSurfaceQuery3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CallSurfaceQueryName3EditPart) {
			((CallSurfaceQueryName3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCallSurfaceQueryLabelFigure());
			return true;
		}
		if (childEditPart instanceof CallSurfaceQueryCallSurfaceQueryParamsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCallSurfaceQueryParamsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CallSurfaceQueryCallSurfaceQueryParamsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CallSurfaceQueryCallSurfaceQueryParamsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getCallSurfaceQueryParamsCompartmentFigure();
			pane.remove(((CallSurfaceQueryCallSurfaceQueryParamsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof CallSurfaceQueryCallSurfaceQueryParamsCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(CallSurfaceQueryName3EditPart.VISUAL_ID));
	}
