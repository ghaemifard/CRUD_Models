...
import delete.diagram.edit.policies.CallSurfaceQuery2ItemSemanticEditPolicy;
...
public class CallSurfaceQuery2EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(CallSurfaceQueryName2EditPart.VISUAL_ID));
	}
