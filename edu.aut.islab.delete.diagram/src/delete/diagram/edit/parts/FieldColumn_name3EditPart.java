 ...
 * @generated
 */
public class FieldColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_name3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Field_3012, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FieldColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
