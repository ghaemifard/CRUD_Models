...
import delete.diagram.edit.policies.TermTermParamsCompartmentCanonicalEditPolicy;
import delete.diagram.edit.policies.TermTermParamsCompartmentItemSemanticEditPolicy;
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DeleteElementTypes.CallSurfaceQuery_3025) {
				return this;
			}
			if (type == DeleteElementTypes.Field_3012) {
				return this;
			}
			if (type == DeleteElementTypes.Literal_3026) {
				return this;
			}
			if (type == DeleteElementTypes.NullLiteral_3027) {
				return this;
			}
			if (type == DeleteElementTypes.Function_3028) {
				return this;
			}
			if (type == DeleteElementTypes.Input_3029) {
				return this;
			}
