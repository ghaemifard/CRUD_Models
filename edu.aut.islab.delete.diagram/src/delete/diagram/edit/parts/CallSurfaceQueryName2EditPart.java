 ...
 * @generated
 */
public class CallSurfaceQueryName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.CallSurfaceQuery_3014, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.CallSurfaceQueryName2EditPart.VISUAL_ID));
		}
		return parser;
	}
