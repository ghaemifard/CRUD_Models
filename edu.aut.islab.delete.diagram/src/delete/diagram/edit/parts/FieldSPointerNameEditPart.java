...
public class FieldSPointerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.FieldSPointer_3043, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FieldSPointerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
