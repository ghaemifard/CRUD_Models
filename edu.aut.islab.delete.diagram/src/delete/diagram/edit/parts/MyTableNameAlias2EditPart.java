 ...
 * @generated
 */
public class MyTableNameAlias2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MyTableNameAlias2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.MyTable_3053, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.MyTableNameAlias2EditPart.VISUAL_ID));
		}
		return parser;
	}
