 ...
 * @generated
 */
public class LiteralValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LiteralValueEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Literal_3016, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.LiteralValueEditPart.VISUAL_ID));
		}
		return parser;
	}
