 ...
 * @generated
 */
public class CallSurfaceQueryColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryColumn_nameName3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return DeleteElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.CallSurfaceQuery_3044, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.CallSurfaceQueryColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
