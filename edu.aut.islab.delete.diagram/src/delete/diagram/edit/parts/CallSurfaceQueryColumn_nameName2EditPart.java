 ...
 * @generated
 */
public class CallSurfaceQueryColumn_nameName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CallSurfaceQueryColumn_nameName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.CallSurfaceQuery_3014, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.CallSurfaceQueryColumn_nameName2EditPart.VISUAL_ID));
		}
		return parser;
	}
