...
public class EqualLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.EqualLink_4006, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.EqualLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
