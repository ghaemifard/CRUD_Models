...
import delete.diagram.edit.policies.Input3ItemSemanticEditPolicy;
...
public class Input3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputColumn_name3EditPart) {
			((InputColumn_name3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(InputColumn_name3EditPart.VISUAL_ID));
	}
