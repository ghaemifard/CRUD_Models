 ...
 * @generated
 */
public class FunctionColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionColumn_nameName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Function_3048, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.FunctionColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
