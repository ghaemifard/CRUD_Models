...
public class NullLiteralColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.NullLiteral_3017, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.NullLiteralColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
