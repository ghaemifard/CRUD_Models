...
public class InputDateDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputDateDef_3003, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputDateDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
