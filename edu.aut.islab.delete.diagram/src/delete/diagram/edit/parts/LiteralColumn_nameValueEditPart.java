...
public class LiteralColumn_nameValueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Literal_3016, getParserElement(),
					DeleteVisualIDRegistry
							.getType(delete.diagram.edit.parts.LiteralColumn_nameValueEditPart.VISUAL_ID));
		}
		return parser;
	}
