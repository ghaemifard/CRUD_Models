...
public class InLinkDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InLink_4011, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InLinkDescEditPart.VISUAL_ID));
		}
		return parser;
	}
