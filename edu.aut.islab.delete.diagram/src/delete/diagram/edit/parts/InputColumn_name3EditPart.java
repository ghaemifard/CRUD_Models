...
public class InputColumn_name3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Input_3049, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputColumn_name3EditPart.VISUAL_ID));
		}
		return parser;
	}
