...
import delete.diagram.edit.policies.Function3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Function3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Function3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Function3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FunctionName3EditPart) {
			((FunctionName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFunctionLabelFigure());
			return true;
		}
		if (childEditPart instanceof FunctionFunctionParamsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFunctionParamsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((FunctionFunctionParamsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FunctionFunctionParamsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFunctionParamsCompartmentFigure();
			pane.remove(((FunctionFunctionParamsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof FunctionFunctionParamsCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(FunctionName3EditPart.VISUAL_ID));
	}
