 ...
 * @generated
 */
public class InputColumn_name2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputColumn_name2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Input_3029, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputColumn_name2EditPart.VISUAL_ID));
		}
		return parser;
	}
