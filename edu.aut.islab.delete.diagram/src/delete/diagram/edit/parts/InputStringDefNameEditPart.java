...
public class InputStringDefNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputStringDef_3001, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputStringDefNameEditPart.VISUAL_ID));
		}
		return parser;
	}
