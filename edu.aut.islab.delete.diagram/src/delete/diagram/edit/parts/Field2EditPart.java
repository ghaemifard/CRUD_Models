...
import delete.diagram.edit.policies.Field2ItemSemanticEditPolicy;
...
public class Field2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldColumn_name2EditPart) {
			((FieldColumn_name2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DeleteVisualIDRegistry.getType(FieldColumn_name2EditPart.VISUAL_ID));
	}
