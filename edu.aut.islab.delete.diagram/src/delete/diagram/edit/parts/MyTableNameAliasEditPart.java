 ...
 * @generated
 */
public class MyTableNameAliasEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MyTableNameAliasEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.MyTable_3051, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.MyTableNameAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
