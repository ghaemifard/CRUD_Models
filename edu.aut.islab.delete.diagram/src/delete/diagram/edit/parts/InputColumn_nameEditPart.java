 ...
 * @generated
 */
public class InputColumn_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputColumn_nameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Input_3019, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputColumn_nameEditPart.VISUAL_ID));
		}
		return parser;
	}
