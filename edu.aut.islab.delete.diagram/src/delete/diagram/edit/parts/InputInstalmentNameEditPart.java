...
public class InputInstalmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.InputInstalment_2001, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.InputInstalmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
