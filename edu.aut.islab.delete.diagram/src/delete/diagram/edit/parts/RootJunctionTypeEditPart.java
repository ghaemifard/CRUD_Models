 ...
 * @generated
 */
public class RootJunctionTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RootJunctionTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.RootJunction_3040, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.RootJunctionTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
