...
public class FieldColumn_nameName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Field_3012, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FieldColumn_nameName3EditPart.VISUAL_ID));
		}
		return parser;
	}
