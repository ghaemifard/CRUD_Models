 ...
 * @generated
 */
public class FieldColumn_nameName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldColumn_nameName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DeleteParserProvider.getParser(DeleteElementTypes.Field_3045, getParserElement(),
					DeleteVisualIDRegistry.getType(delete.diagram.edit.parts.FieldColumn_nameName4EditPart.VISUAL_ID));
		}
		return parser;
	}
