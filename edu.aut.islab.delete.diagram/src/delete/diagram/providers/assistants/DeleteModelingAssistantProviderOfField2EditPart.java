 ...
 * @generated
 */
public class DeleteModelingAssistantProviderOfField2EditPart extends DeleteModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((Field2EditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(Field2EditPart source) {
		List<IElementType> types = new ArrayList<IElementType>(11);
		types.add(DeleteElementTypes.InnerjoinRels_4001);
		types.add(DeleteElementTypes.LeftOuterJoinRels_4002);
		types.add(DeleteElementTypes.RightOuterJoinRels_4003);
		types.add(DeleteElementTypes.FullOuterJoinRels_4004);
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((Field2EditPart) sourceEditPart, targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(Field2EditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((Field2EditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(Field2EditPart source, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == DeleteElementTypes.InnerjoinRels_4001) {
		...
		} else if (relationshipType == DeleteElementTypes.LeftOuterJoinRels_4002) {
			types.add(DeleteElementTypes.Field_3052);
			types.add(DeleteElementTypes.Field_3015);
			types.add(DeleteElementTypes.Field_3012);
			types.add(DeleteElementTypes.Field_3045);
		} else if (relationshipType == DeleteElementTypes.RightOuterJoinRels_4003) {
			types.add(DeleteElementTypes.Field_3052);
			types.add(DeleteElementTypes.Field_3015);
			types.add(DeleteElementTypes.Field_3012);
			types.add(DeleteElementTypes.Field_3045);
		} else if (relationshipType == DeleteElementTypes.FullOuterJoinRels_4004) {
			types.add(DeleteElementTypes.Field_3052);
			types.add(DeleteElementTypes.Field_3015);
			types.add(DeleteElementTypes.Field_3012);
			types.add(DeleteElementTypes.Field_3045);
		} else if (relationshipType == DeleteElementTypes.EqualLink_4006) {
			types.add(DeleteElementTypes.Field_3052);
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((Field2EditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(Field2EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(11);
		types.add(DeleteElementTypes.InnerjoinRels_4001);
		types.add(DeleteElementTypes.LeftOuterJoinRels_4002);
		types.add(DeleteElementTypes.RightOuterJoinRels_4003);
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((Field2EditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(Field2EditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == DeleteElementTypes.InnerjoinRels_4001) {
			types.add(DeleteElementTypes.Field_3052);
			types.add(DeleteElementTypes.Field_3015);
