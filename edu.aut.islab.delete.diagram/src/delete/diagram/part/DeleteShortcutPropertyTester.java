 ...
 * @generated
 */
public class DeleteShortcutPropertyTester extends PropertyTester {
	...
	*/
	public boolean test(Object receiver, String method, Object[] args, Object expectedValue) {
		...
		if (SHORTCUT_PROPERTY.equals(method)) {
			...
			if (annotation != null) {
				return DeleteSurfaceEditPart.MODEL_ID.equals(annotation.getDetails().get("modelID")); //$NON-NLS-1$
			}
		}
		return false;
	}
