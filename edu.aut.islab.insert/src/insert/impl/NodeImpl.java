 ...
 * </p>
 * <ul>
 *   <li>{@link insert.impl.NodeImpl#getType <em>Type</em>}</li>
 *   <li>{@link insert.impl.NodeImpl#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link insert.impl.NodeImpl#isListable <em>Listable</em>}</li>
 *   <li>{@link insert.impl.NodeImpl#getColumn_name <em>Column name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NodeImpl extends AbstractNodeImpl implements Node {
	...
	protected EClass eStaticClass() {
		return InsertPackage.Literals.NODE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InsertPackage.NODE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.NODE__TYPE, oldType, type));
	}
	...
	public Subtype getSubtype() {
		if (subtype != null && subtype.eIsProxy()) {
			...
			if (subtype != oldSubtype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InsertPackage.NODE__SUBTYPE, oldSubtype, subtype));
			}
		}
		return subtype;
	}
	...
	public void setSubtype(Subtype newSubtype) {
		...
		subtype = newSubtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.NODE__SUBTYPE, oldSubtype, subtype));
	}
	...
	public void setListable(boolean newListable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.NODE__LISTABLE, oldListable, listable));
	}
	...
	public void setColumn_name(String newColumn_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.NODE__COLUMN_NAME, oldColumn_name, column_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InsertPackage.NODE__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case InsertPackage.NODE__SUBTYPE:
