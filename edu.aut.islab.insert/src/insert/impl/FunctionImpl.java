 ...
 * </p>
 * <ul>
 *   <li>{@link insert.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link insert.impl.FunctionImpl#getFuncDef <em>Func Def</em>}</li>
 *   <li>{@link insert.impl.FunctionImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionImpl extends NodeImpl implements Function {
	...
	protected EClass eStaticClass() {
		return InsertPackage.Literals.FUNCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.FUNCTION__NAME, oldName, name));
	}
	...
	public FunctionDef getFuncDef() {
		if (funcDef != null && funcDef.eIsProxy()) {
			...
			if (funcDef != oldFuncDef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InsertPackage.FUNCTION__FUNC_DEF, oldFuncDef, funcDef));
			}
		}
		return funcDef;
	}
	...
	public void setFuncDef(FunctionDef newFuncDef) {
		...
		funcDef = newFuncDef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InsertPackage.FUNCTION__FUNC_DEF, oldFuncDef, funcDef));
	}
	...
	public EList<Node> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<Node>(Node.class, this, InsertPackage.FUNCTION__PARAMS);
		}
		return params;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InsertPackage.FUNCTION__NAME:
				return getName();
			case InsertPackage.FUNCTION__FUNC_DEF:
