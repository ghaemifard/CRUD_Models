 ...
 * </p>
 * <ul>
 *   <li>{@link update.impl.SortInstalmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link update.impl.SortInstalmentImpl#getPointers <em>Pointers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SortInstalmentImpl extends EObjectImpl implements SortInstalment {
	...
	protected EClass eStaticClass() {
		return UpdatePackage.Literals.SORT_INSTALMENT;
	}
	...
	public EList<FieldSPointer> getPointers() {
		if (pointers == null) {
			pointers = new EObjectContainmentEList<FieldSPointer>(FieldSPointer.class, this, UpdatePackage.SORT_INSTALMENT__POINTERS);
		}
		return pointers;
	}
