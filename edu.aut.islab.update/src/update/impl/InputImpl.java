 ...
 * </p>
 * <ul>
 *   <li>{@link update.impl.InputImpl#getInputRef <em>Input Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends NodeImpl implements Input {
	...
	protected EClass eStaticClass() {
		return UpdatePackage.Literals.INPUT;
	}
		...
		if (inputRef != null && inputRef.eIsProxy()) {
			...
			if (inputRef != oldInputRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UpdatePackage.INPUT__INPUT_REF, oldInputRef, inputRef));
			}
		}
		return inputRef;
	}
	...
	public void setInputRef(InputDef newInputRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UpdatePackage.INPUT__INPUT_REF, oldInputRef, inputRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UpdatePackage.INPUT__INPUT_REF:
