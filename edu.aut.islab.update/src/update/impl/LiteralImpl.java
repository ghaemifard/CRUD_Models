 ...
 * </p>
 * <ul>
 *   <li>{@link update.impl.LiteralImpl#getValue <em>Value</em>}</li>
 *   <li>{@link update.impl.LiteralImpl#getLtype <em>Ltype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralImpl extends NodeImpl implements Literal {
	...
	protected EClass eStaticClass() {
		return UpdatePackage.Literals.LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UpdatePackage.LITERAL__VALUE, oldValue, value));
	}
	...
	public void setLtype(LiteralType newLtype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UpdatePackage.LITERAL__LTYPE, oldLtype, ltype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UpdatePackage.LITERAL__VALUE:
				return getValue();
			case UpdatePackage.LITERAL__LTYPE:
				return getLtype();
		}
