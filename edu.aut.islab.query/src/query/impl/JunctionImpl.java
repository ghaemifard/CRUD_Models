 ...
 * </p>
 * <ul>
 *   <li>{@link query.impl.JunctionImpl#getType <em>Type</em>}</li>
 *   <li>{@link query.impl.JunctionImpl#getRels <em>Rels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JunctionImpl extends AbstractConditionElementImpl implements Junction {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.JUNCTION;
	}
	...
	public void setType(JuncType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.JUNCTION__TYPE, oldType, type));
	}
	...
	public EList<JuncRelationship> getRels() {
		if (rels == null) {
			rels = new EObjectWithInverseResolvingEList<JuncRelationship>(JuncRelationship.class, this, QueryPackage.JUNCTION__RELS, QueryPackage.JUNC_RELATIONSHIP__SOURCE);
		}
		return rels;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QueryPackage.JUNCTION__RELS:
