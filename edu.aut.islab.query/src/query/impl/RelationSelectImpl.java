 ...
 * </p>
 * <ul>
 *   <li>{@link query.impl.RelationSelectImpl#getSource <em>Source</em>}</li>
 *   <li>{@link query.impl.RelationSelectImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link query.impl.RelationSelectImpl#getOpType <em>Op Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RelationSelectImpl extends EObjectImpl implements RelationSelect {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.RELATION_SELECT;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.RELATION_SELECT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Field newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.RELATION_SELECT__SOURCE, oldSource, source));
	}
	...
	public Field getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.RELATION_SELECT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Field newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.RELATION_SELECT__TARGET, oldTarget, target));
	}
	...
	public void setOpType(RelationSelectOperationType newOpType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.RELATION_SELECT__OP_TYPE, oldOpType, opType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.RELATION_SELECT__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case QueryPackage.RELATION_SELECT__TARGET:
