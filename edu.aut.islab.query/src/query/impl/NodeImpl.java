 ...
 * </p>
 * <ul>
 *   <li>{@link query.impl.NodeImpl#getType <em>Type</em>}</li>
 *   <li>{@link query.impl.NodeImpl#getSubtype <em>Subtype</em>}</li>
 *   <li>{@link query.impl.NodeImpl#getColumn_name <em>Column name</em>}</li>
 *   <li>{@link query.impl.NodeImpl#isListable <em>Listable</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NodeImpl extends AbstractNodeImpl implements Node {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.NODE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.NODE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.NODE__TYPE, oldType, type));
	}
	...
	public Subtype getSubtype() {
		if (subtype != null && subtype.eIsProxy()) {
			...
			if (subtype != oldSubtype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.NODE__SUBTYPE, oldSubtype, subtype));
			}
		}
		return subtype;
	}
	...
	public void setSubtype(Subtype newSubtype) {
		...
		subtype = newSubtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.NODE__SUBTYPE, oldSubtype, subtype));
	}
	...
	public void setColumn_name(String newColumn_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.NODE__COLUMN_NAME, oldColumn_name, column_name));
	}
	...
	public void setListable(boolean newListable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.NODE__LISTABLE, oldListable, listable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.NODE__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case QueryPackage.NODE__SUBTYPE:
				if (resolve) return getSubtype();
				return basicGetSubtype();
			case QueryPackage.NODE__COLUMN_NAME:
				return getColumn_name();
			case QueryPackage.NODE__LISTABLE:
				return isListable();
		}
