 ...
 * </p>
 * <ul>
 *   <li>{@link query.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link query.impl.FunctionImpl#getFuncDef <em>Func Def</em>}</li>
 *   <li>{@link query.impl.FunctionImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionImpl extends NodeImpl implements Function {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.FUNCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.FUNCTION__NAME, oldName, name));
	}
	...
	public FunctionDef getFuncDef() {
		if (funcDef != null && funcDef.eIsProxy()) {
			...
			if (funcDef != oldFuncDef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.FUNCTION__FUNC_DEF, oldFuncDef, funcDef));
			}
		}
		return funcDef;
	}
	...
	public void setFuncDef(FunctionDef newFuncDef) {
		...
		funcDef = newFuncDef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.FUNCTION__FUNC_DEF, oldFuncDef, funcDef));
	}
	...
	public EList<Node> getParams() {
		if (params == null) {
			params = new EObjectContainmentEList<Node>(Node.class, this, QueryPackage.FUNCTION__PARAMS);
		}
		return params;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QueryPackage.FUNCTION__PARAMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.FUNCTION__NAME:
				return getName();
			case QueryPackage.FUNCTION__FUNC_DEF:
