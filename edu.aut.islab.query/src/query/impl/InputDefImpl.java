 ...
 * </p>
 * <ul>
 *   <li>{@link query.impl.InputDefImpl#getName <em>Name</em>}</li>
 *   <li>{@link query.impl.InputDefImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link query.impl.InputDefImpl#isListable <em>Listable</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InputDefImpl extends EObjectImpl implements InputDef {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.INPUT_DEF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.INPUT_DEF__NAME, oldName, name));
	}
	...
	public void setIndex(int newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.INPUT_DEF__INDEX, oldIndex, index));
	}
	...
	public void setListable(boolean newListable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.INPUT_DEF__LISTABLE, oldListable, listable));
	}
