 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.InputDefImpl#getName <em>Name</em>}</li>
 *   <li>{@link delete.impl.InputDefImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link delete.impl.InputDefImpl#isListable <em>Listable</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InputDefImpl extends EObjectImpl implements InputDef {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.INPUT_DEF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.INPUT_DEF__NAME, oldName, name));
	}
	...
	public void setIndex(int newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.INPUT_DEF__INDEX, oldIndex, index));
	}
	...
	public void setListable(boolean newListable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.INPUT_DEF__LISTABLE, oldListable, listable));
	}
