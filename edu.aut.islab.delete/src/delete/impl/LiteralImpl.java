 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.LiteralImpl#getValue <em>Value</em>}</li>
 *   <li>{@link delete.impl.LiteralImpl#getLtype <em>Ltype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralImpl extends NodeImpl implements Literal {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.LITERAL__VALUE, oldValue, value));
	}
	...
	public void setLtype(LiteralType newLtype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.LITERAL__LTYPE, oldLtype, ltype));
	}
