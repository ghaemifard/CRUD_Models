 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.InputImpl#getInputRef <em>Input Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends NodeImpl implements Input {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.INPUT;
	}
		...
		if (inputRef != null && inputRef.eIsProxy()) {
			...
			if (inputRef != oldInputRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DeletePackage.INPUT__INPUT_REF, oldInputRef, inputRef));
			}
		}
		return inputRef;
	}
	...
	public void setInputRef(InputDef newInputRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.INPUT__INPUT_REF, oldInputRef, inputRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DeletePackage.INPUT__INPUT_REF:
