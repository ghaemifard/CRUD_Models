 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.JunctionImpl#getType <em>Type</em>}</li>
 *   <li>{@link delete.impl.JunctionImpl#getRels <em>Rels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JunctionImpl extends AbstractConditionElementImpl implements Junction {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.JUNCTION;
	}
	...
	public void setType(JuncType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.JUNCTION__TYPE, oldType, type));
	}
	...
	public EList<JuncRelationship> getRels() {
		if (rels == null) {
			rels = new EObjectWithInverseResolvingEList<JuncRelationship>(JuncRelationship.class, this, DeletePackage.JUNCTION__RELS, DeletePackage.JUNC_RELATIONSHIP__SOURCE);
		}
		return rels;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DeletePackage.JUNCTION__RELS:
