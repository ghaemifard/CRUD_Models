 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.ConditionInstalmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link delete.impl.ConditionInstalmentImpl#getParts <em>Parts</em>}</li>
 *   <li>{@link delete.impl.ConditionInstalmentImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionInstalmentImpl extends EObjectImpl implements ConditionInstalment {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.CONDITION_INSTALMENT;
	}
	...
	public EList<AbstractConditionElement> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<AbstractConditionElement>(AbstractConditionElement.class, this, DeletePackage.CONDITION_INSTALMENT__PARTS);
		}
		return parts;
	}
	...
	public EList<JuncRelationship> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<JuncRelationship>(JuncRelationship.class, this, DeletePackage.CONDITION_INSTALMENT__LINKS);
		}
		return links;
	}
