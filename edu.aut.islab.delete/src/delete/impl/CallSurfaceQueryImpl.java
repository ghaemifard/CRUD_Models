 ...
 * </p>
 * <ul>
 *   <li>{@link delete.impl.CallSurfaceQueryImpl#getSurfaceName <em>Surface Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallSurfaceQueryImpl extends FunctionImpl implements CallSurfaceQuery {
	...
	protected EClass eStaticClass() {
		return DeletePackage.Literals.CALL_SURFACE_QUERY;
	}
	...
	public void setSurfaceName(String newSurfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeletePackage.CALL_SURFACE_QUERY__SURFACE_NAME, oldSurfaceName, surfaceName));
	}
