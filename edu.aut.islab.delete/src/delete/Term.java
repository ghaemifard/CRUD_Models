 ...
 * </p>
 * <ul>
 *   <li>{@link delete.Term#getParams <em>Params</em>}</li>
 *   <li>{@link delete.Term#getTitle <em>Title</em>}</li>
 *   <li>{@link delete.Term#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @see delete.DeletePackage#getTerm()
...
public interface Term extends AbstractConditionElement {
	 ...
	 * @see delete.DeletePackage#getTerm_Params()
	 ...
	 * @see delete.DeletePackage#getTerm_Title()
	 ...
	 * @see delete.DeletePackage#getTerm_Link()
	...
	/**
	 * Sets the value of the '{@link delete.Term#getLink <em>Link</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
